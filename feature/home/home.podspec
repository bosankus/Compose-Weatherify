Pod::Spec.new do |spec|
    ...
    spec.authors                  = ''
    spec.license                  = ''
    spec.summary                  = 'Weatherify Home feature module'
    ...
    if !Dir.exist?('build/cocoapods/framework/home.framework') || Dir.empty?('build/cocoapods/framework/home.framework')
        raise "
        Kotlin framework 'home' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ./gradlew :feature:home:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':feature:home',
        'PRODUCT_MODULE_NAME' => 'home',
    }
    spec.script_phases = [
        {
            :name => 'Build home',
